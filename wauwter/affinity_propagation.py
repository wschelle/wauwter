...
def aff_prop(M,preference=None,prefmultiply=1,lambda_damp=0.5,maxiter=8,maxtries=50,verbose=False,bit16=0,simple_numbering=True):
    # 'Affinitity Propagation clustering for IDL, and for Python :)'
    # 'Supply matrix: [data points,features]'
    # 'Example: M=[100,3] for 100 points with 3 values each (e.g. x,y,z)'
